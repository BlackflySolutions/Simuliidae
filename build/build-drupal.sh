...
DOCKER_BUILDKIT=1 docker build --target=drupal-base -t drupal-civicrm-base:9.4-php8.1-apache-buster ../reference/drupal/9.4/php8.1/apache-buster/
DOCKER_BUILDKIT=1 docker build --target= -t drupal-civicrm:9.4-php8.1-apache-buster ../reference/drupal/9.4/php8.1/apache-buster/
